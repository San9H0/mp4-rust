...
impl Default for OpusBox {
    fn default() -> Self {
        Self {
            ...
            btrt: Some(BtrtBox::new(96000, 96000)),
        }
    }
}
    ...
    fn read_box(reader: &mut R, size: u64) -> Result<Self> {
        ...
        loop {
            ...
            if name == BoxType::OpusSpecificBox {
                ...
                break;
            } else if name == BoxType::BtrtBox {
                btrt = Some(BtrtBox::read_box(reader, s)?);
                break;
            } else {
                // Skip boxes
...
impl Default for OpusSpecificBox {
    fn default() -> Self {
        Self {
            version: 0,
